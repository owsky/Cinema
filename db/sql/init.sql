...
INSERT INTO public.movies(movies_id, movies_title, movies_duration, movies_genre, movies_synopsis, movies_director, movies_date) VALUES
    ...
    (11, 'The Shawshank Redemption', 142, 'Drama', 'Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency.', 11, '1994-10-14'),
    (12, 'The Godfather', 175, 'Drama', 'The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.', 12, '1972-03-24'),
...
INSERT INTO public.users(users_id, users_email, users_name, users_gender, users_surname, users_pwd, users_balance, users_is_manager) VALUES
    (1, 'manager', 'manager', 'M', 'manager', 'manager', NULL, True),
